...
export default function Marquee() {
    return (
        <div className="relative w-full overflow-hidden bg-black py-16">
            {/* <div className="absolute inset-0 bg-gradient-to-r from-emerald-950 via-transparent to-emerald-950 z-10" /> */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#01151f] via-transparent to-[#01151f] z-10" />
            <motion.div
